...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('client', '0059_alter_order_bill_name_delete_historicalorder'),
    ...
    operations = [
        migrations.AlterField(
            model_name='order',
            name='bill_name',
            field=models.CharField(blank=True, default=1771, max_length=1000, null=True),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bill_name', models.CharField(blank=True, default=1771, max_length=1000, null=True)),
