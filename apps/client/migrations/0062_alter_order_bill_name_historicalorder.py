# Generated by Django 5.1.1 on 2024-10-23 13:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('client', '0061_alter_order_bill_name_delete_historicalorder'),
    ...
    operations = [
        migrations.AlterField(
            model_name='order',
            name='bill_name',
            field=models.CharField(blank=True, default=2453, max_length=1000, null=True),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bill_name', models.CharField(blank=True, default=2453, max_length=1000, null=True)),
