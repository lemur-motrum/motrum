...
urlpatterns = [
    ...
    path("solutions/", views.index, name="solutions"),#решения все
    path("marking", views.index, name="marking"),#решения маркировка
    path("cobots", views.index, name="cobots"),#решения коботы
    path("shkaf-upravleniya", views.index, name="shkaf-upravleniya"),#сборка шкафов управления
    path("contact", views.index, name="contact"),#контакты
    path("cart", views.cart, name="cart"),#корзина

    
    path("privacy-policy", views.index, name="privacy-policy"),#политика конфиденциальности
