...
from apps.projects_web.models import ClientCategoryProject, Project, ProjectClientCategoryProject, ProjectClientCategoryProjectMarking
...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    projectclientcategoryprojectmarking_set = ProjectClientCategoryProjectMarkingSerializer(read_only=False, many=True)
