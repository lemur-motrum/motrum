    ...
    try:
        ...
        if requisites:
            ...
            if kpp_req.kpp:
                ...
                text_buyer_inn = f"ИНН {requisites.inn} <br />Р/с {account_requisites.account_requisites}<br />{account_requisites.bank}<br />БИК {account_requisites.bic}<br />К/с {account_requisites.kpp}<br></br><br></br>"
        else:
