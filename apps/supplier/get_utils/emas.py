...
def get_emas():
    ...
    def get_emas_categoru():
        ...
        category = root.findall("./Классификатор/Группы/Группа/Ид")
        for cat in category:
                ...
                for groupe_item in group_supplier_item:
                    ...
                    if groupe_supplier_item:
                        ...
                        for sub_groupe_item in sub_groupe:
                            ...
                            for sub_groupe_supplier_names in sub_groupe_supplier_name:
                                sub_group_supplier_name_text = (
                                    sub_groupe_supplier_names.text
                                )
                            print(sub_group_supplier_name_text)
                            ...
                            SupplierCategoryProductAll.objects.update_or_create(
                                ...
                                create_defaults={"name": sub_group_supplier_name_text},
                            )
    ...
    def get_emas_product():
        ...
        first = 0
        # разбираем строки
        for index in range(sheet.min_row, sheet.max_row):
