...
from apps.core.utils import delete_everything_in_folder, get_file_path_add_more_doc, get_file_path_add_more_vac
from apps.core.utils_web import send_email_message_and_file, send_email_message_and_file_alternative
